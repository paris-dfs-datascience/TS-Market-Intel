...
Run standalone (from the repo root, as a module):
    python -m market_intel.export_csv                  # uses get_sink() and today's date
    python -m market_intel.export_csv 2026-05-19       # specific date
