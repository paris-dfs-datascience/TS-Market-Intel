...
ACCOUNTS = {
    "Education & Research": [
        ...
        "STANFORD EQUIPMENT",
        "UNIVERSITY OF MASSACHUSETTS", "OKLAHOMA STATE UNIVERSITY",
    ],
    "BioPharma": [
    ...
    "Industrial": [
        ...
        "AXONICS MODULATION",
        "MACOM TECHNOLOGY SOLUTIONS", "GLOBAL WAFERS",
    ],
    "Government": [
...
ACCOUNT_ALIASES = {
    ...
    "MCKINNEY SPECIALTY LABS":        ["McKinney Specialty Labs", "McKinney Specialty Laboratory"],
    ...
    "MACOM TECHNOLOGY SOLUTIONS":     ["MACOM", "M/A-COM Technology Solutions"],
    "GLOBAL WAFERS":                  ["GlobalWafers", "GlobalWafers Co."],
    ...
    "SCSTATE NASPO":                  ["SC State NASPO", "South Carolina NASPO", "NASPO ValuePoint South Carolina"],
}
