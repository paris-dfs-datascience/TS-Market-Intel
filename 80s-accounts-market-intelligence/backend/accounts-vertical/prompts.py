...
GROUNDING_INSTRUCTION = (
    "IMPORTANT: You must use Google Search to find all results. "
    "Only include signals you found via live Google Search with a real, verifiable source URL. "
    "Do NOT use your training data or internal knowledge — every record you return must have a "
    "source_url from an actual web page retrieved in this search. "
    "If Google Search returns no relevant results, return an empty array []. "
)

SUMMARY_INSTRUCTION = (
    "'summary' = 3 to 5 sentences: what happened, who is involved, the scale or dollar value "
    "if known, location if relevant, and any important context. Be specific — do not truncate or generalise. "
)

WHYITMATTERS_INSTRUCTION = (
    "'why_it_matters' = one concise sentence on why a Thomas Scientific lab supply sales rep "
    "should act on this signal now — be specific about the supply category or product type. "
)
...
def build_prompt(signal: str, entity: str, category: str,
    ...
    if signal == "grant":
        ...
        return (
            ...
            f"'event_date' = the date this event was announced or published, in format 'Month DD, YYYY' or 'Month YYYY' if exact date unknown; use the article publication date as fallback — never return null. "
    ...
    if signal == "faculty":
        ...
        return (
            ...
            f"'event_date' = the date this hire was announced or published, in format 'Month DD, YYYY' or 'Month YYYY' if exact date unknown; use the article publication date as fallback — never return null. "
    ...
    if signal == "capital":
        return (
            ...
            f"'event_date' = the date this project was announced or published, in format 'Month DD, YYYY' or 'Month YYYY' if exact date unknown; use the article publication date as fallback — never return null. "
    ...
    if signal == "contract":
        ...
        return (
            ...
            f"'event_date' = the date this contract or RFP was announced or posted, in format 'Month DD, YYYY' or 'Month YYYY' if exact date unknown; use the article publication date as fallback — never return null. "
    ...
    if signal == "pipeline":
        ...
        return (
            ...
            f"'event_date' = the date this pipeline event was announced or published, in format 'Month DD, YYYY' or 'Month YYYY' if exact date unknown; use the article publication date as fallback — never return null. "
    ...
    if signal == "expansion":
        return (
            ...
            f"'event_date' = the date this expansion was announced or published, in format 'Month DD, YYYY' or 'Month YYYY' if exact date unknown; use the article publication date as fallback — never return null. "
    ...
    if signal == "partnership":
        ...
        return (
            ...
            f"'event_date' = the date this partnership or deal was announced or published, in format 'Month DD, YYYY' or 'Month YYYY' if exact date unknown; use the article publication date as fallback — never return null. "
    ...
    if signal == "funding":
        ...
        return (
            ...
            f"'event_date' = the date this funding was announced or closed, in format 'Month DD, YYYY' or 'Month YYYY' if exact date unknown; use the article publication date as fallback — never return null. "
    ...
    if signal == "regulatory":
        ...
        return (
            ...
            f"'event_date' = the date this regulatory event occurred or was published, in format 'Month DD, YYYY' or 'Month YYYY' if exact date unknown; use the article publication date as fallback — never return null. "
    ...
    if signal == "hiring":
        ...
        return (
            ...
            f"'event_date' = the date this hiring announcement was published, in format 'Month DD, YYYY' or 'Month YYYY' if exact date unknown; use the article publication date as fallback — never return null. "
    ...
    if signal == "tender":
        ...
        return (
            ...
            f"'event_date' = the date this tender was published or posted, in format 'Month DD, YYYY' or 'Month YYYY' if exact date unknown; use the article publication date as fallback — never return null. "
    ...
    if signal == "breakthrough":
        ...
        return (
            ...
            f"'event_date' = the date this breakthrough or award was announced, in format 'Month DD, YYYY' or 'Month YYYY' if exact date unknown; use the article publication date as fallback — never return null. "
    ...
    if signal == "ma":
        ...
        return (
            ...
            f"'event_date' = the date this M&A event was announced or reported, in format 'Month DD, YYYY' or 'Month YYYY' if exact date unknown; use the article publication date as fallback — never return null. "
    ...
    if signal == "spinoff":
        ...
        return (
            ...
            f"'event_date' = the date this spinoff was announced or incorporated, in format 'Month DD, YYYY' or 'Month YYYY' if exact date unknown; use the article publication date as fallback — never return null. "
    ...
    if signal == "production":
        ...
        return (
            ...
            f"'event_date' = the date this production change was announced or published, in format 'Month DD, YYYY' or 'Month YYYY' if exact date unknown; use the article publication date as fallback — never return null. "
    ...
    if signal == "volume":
        ...
        return (
            ...
            f"'event_date' = the date this volume change was reported or announced, in format 'Month DD, YYYY' or 'Month YYYY' if exact date unknown; use the article publication date as fallback — never return null. "
    ...
    if signal == "competitive":
        ...
        return (
            ...
            f"'event_date' = the date this contract award or competitive event was announced, in format 'Month DD, YYYY' or 'Month YYYY' if exact date unknown; use the article publication date as fallback — never return null. "
    ...
    if signal == "mandate":
        ...
        return (
            ...
            f"'event_date' = the date this mandate was announced or passed, in format 'Month DD, YYYY' or 'Month YYYY' if exact date unknown; use the article publication date as fallback — never return null. "
    ...
    if signal == "legislation":
        ...
        return (
            ...
            f"'event_date' = the date this bill or budget was passed or announced, in format 'Month DD, YYYY' or 'Month YYYY' if exact date unknown; use the article publication date as fallback — never return null. "
    ...
    if signal == "closure":
        ...
        return (
            ...
            f"'event_date' = the date this closure was announced or reported, in format 'Month DD, YYYY' or 'Month YYYY' if exact date unknown; use the article publication date as fallback — never return null. "
