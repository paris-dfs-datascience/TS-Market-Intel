"""
test_gemini_api.py -- Probe Gemini grounded-search with the same key + auth path
the pipeline uses.
...
Usage:
    # Build into the image, then PATCH job with command: ["python", "test_gemini_api.py"]
...
from engine import _resolve_api_key, MODEL
